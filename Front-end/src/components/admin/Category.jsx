                  ...
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        ...
                        <span className="text-[11px] text-slate-400 font-semibold tracking-wider mt-1">ID: #00{cat.id}</span>
                      </div>
                    </div>
                  </td>
